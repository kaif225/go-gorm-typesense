...
type Users struct {
	...
	PasswordChangedAt    string `gorm:"column:password_changed_at" json:"password_changed_at,omitempty"`
	...
	PasswordTokenExpired string `gorm:"column:password_token_expired" json:"password_token_expired,omitempty"`
